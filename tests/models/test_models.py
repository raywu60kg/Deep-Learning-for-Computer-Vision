...
class TestModels(unittest.TestCase):
    ...
    def test_inceptionnet_forword(self) -> None:
        model1 = InceptionNet(input_shape=(1, 128, 128), num_label=10)
        model2 = InceptionNet(input_shape=(1, 224, 128), num_label=10)
        model3 = InceptionNet(input_shape=(3, 224, 224), num_label=10)
        test_image1 = torch.zeros(size=(1, 1, 128, 128), dtype=torch.float32)
        test_image2 = torch.zeros(size=(1, 1, 224, 128), dtype=torch.float32)
        test_image3 = torch.zeros(size=(1, 3, 224, 224), dtype=torch.float32)
        output_image1 = model1.forward(test_image1)
    ...
    def test_resnet_forword(self) -> None:

...
net = nn.Sequential(b1, b2, b3, b4, b5, nn.Linear(1024, num_label))
```
## Layer shapes
b1 output shape:     torch.Size([batch_size, 64, 24, 24])
b2 output shape:     torch.Size([batch_size, 192, 12, 12])
b3 output shape:     torch.Size([batch_size, 480, 6, 6])
b4 output shape:     torch.Size([batch_size, 832, 3, 3])
